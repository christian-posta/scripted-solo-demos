...
run "kubectl label namespace web-api istio-injection=enabled"
run "kubectl rollout restart deploy -n web-api"

run "kubectl label namespace recommendation istio-injection=enabled"
run "kubectl rollout restart deploy  -n recommendation"

run "kubectl label namespace purchase-history istio-injection=enabled"
run "kubectl rollout restart deploy -n purchase-history"
