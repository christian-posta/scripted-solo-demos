...
helm install gloo glooe/gloo-ee -f ~/scripted-demos/gloo-all/resources/config/default-ee-values.yaml --version $VERSION --namespace gloo-system --create-namespace --set-string license_key=$GLOO_LICENSE
