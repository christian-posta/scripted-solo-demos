...
GLOO_MESH_VERSION_UPGRADE="1.1.5"
...
helm upgrade gloo-mesh-enterprise gloo-mesh-enterprise/gloo-mesh-enterprise --kube-context $MGMT_CONTEXT -n gloo-mesh --version=$GLOO_MESH_VERSION_UPGRADE --set licenseKey=${GLOO_MESH_LICENSE} --set rbac-webhook.enabled=false --set metricsBackend.prometheus.enabled=true --set gloo-mesh-ui.relayClientAuthority=enterprise-networking.gloo-mesh 
