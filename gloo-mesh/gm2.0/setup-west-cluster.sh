...
kubectl get secret -n gloo-mesh relay-identity-token-secret --context $MGMT_CONTEXT -oyaml | kubectl apply --context $CLUSTER_1 -f -
kubectl get secret -n gloo-mesh relay-root-tls-secret --context $MGMT_CONTEXT -oyaml | kubectl apply --context $CLUSTER_1 -f -
...
kubectl --context $CLUSTER_1 apply -f ./resources/sample-apps/sleep.yaml -n sleep

kubectl --context $CLUSTER_1 label ns default istio-injection-
kubectl --context $CLUSTER_1 apply -f ./resources/sample-apps/sleep.yaml -n default