...
../scripts/check.sh $CLUSTER1 gm-iop-1-13
../scripts/check.sh $CLUSTER2 gm-iop-1-13


kubectl --context ${CLUSTER1} -n istio-system rollout status deploy/istiod-1-13
kubectl --context ${CLUSTER2} -n istio-system rollout status deploy/istiod-1-13
...
kubectl --context ${CLUSTER1} label namespace sleep istio.io/rev=1-13
...
kubectl --context ${CLUSTER2} label namespace sleep istio.io/rev=1-13
